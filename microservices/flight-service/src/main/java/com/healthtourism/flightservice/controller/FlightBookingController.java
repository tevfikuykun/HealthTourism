...
public class FlightBookingController {
    ...
    public ResponseEntity<List<FlightBookingDTO>> searchFlights(
            @RequestParam String departureCity, @RequestParam String arrivalCity) {
    ...
    @GetMapping("/price")
    public ResponseEntity<List<FlightBookingDTO>> getFlightsByPrice(@RequestParam(defaultValue = "5000") BigDecimal maxPrice) {

package com.healthtourism.transferservice.entity;
...
public class TransferService {
    ...
    @Column(nullable = false) private Boolean hasMeetAndGreet;
    @Column(nullable = false) private Boolean hasLuggageAssistance;
    @Column(nullable = false) private Boolean hasWifi;
    @Column(nullable = false) private Boolean hasChildSeat;
